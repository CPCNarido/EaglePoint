    ...
    try {
      ...
      try {
        ...
        if (model === 'Player') {
          ...
          } else if (action === 'update' && params.args && params.args.data) {
        ...
        if (model === 'BayAssignment') {
          if (action === 'create' && params.args && params.args.data) {
            actorId = params.args.data.dispatcher_id ?? params.args.data.serviceman_id ?? undefined;
        ...
        if (model === 'BallTransaction' && action === 'create' && params.args && params.args.data) {
      ...
      return result;
        ...
        console.warn('Prisma middleware skipped: $use is not available on PrismaClient instance');
      }
    } catch (outer) {
