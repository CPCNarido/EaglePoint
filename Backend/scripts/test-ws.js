/* Backend/scripts/test-ws.js
   Copy of workspace-level test script placed inside Backend so it resolves dependencies
   when run from the Backend folder (uses Backend/node_modules/socket.io-client).
*/
